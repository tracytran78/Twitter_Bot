...
#def send_tweet (journalists)
#  journalists.each do |i|
#  login_twitter.update("#{i} Lucky you, mon programme ruby vous a sélectioné afin que je vous tweet. You're one in a million! #bonjour_monde")
#  end
#end

#send_tweet (journalists)

#def accounts_to_like
#  favorite_accounts = login_twitter.search("#bonjour_monde", result_type: "recent").take(25)
#  return favorite_accounts
#end

#def like
#  return login_twitter.favorite(accounts_to_like)
#end

#like

#def accounts_to_follow
#  follow_accounts = []
#   login_twitter.search("#bonjour_monde", result_type: "recent").take(20).collect do |i|
#   follow_accounts << "#{i.user.screen_name}"
#   end
#  return follow_accounts
#end

#def follow
#  return login_twitter.follow(accounts_to_follow)
#end
